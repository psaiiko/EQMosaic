...
This tool got my accounts banned recently, this code dump is mainly to serve as an example for people who would want to make something similar (game process spawning, window adjustments, render capture & thumbnail, .ini overrides etc...)
